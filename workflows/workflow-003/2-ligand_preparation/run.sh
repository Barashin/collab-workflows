...
cd "${SCRIPT_DIR}"
python3 "${SCRIPT_DIR}/node_01_download_ligands.py"
python3 "${SCRIPT_DIR}/node_02_unpack_ligands.py"
python3 "${SCRIPT_DIR}/node_03_ligand_selection.py"
python3 "${SCRIPT_DIR}/node_04_real_ligand_addition.py"
python3 "${SCRIPT_DIR}/node_05_prepare_ligands.py"
python3 "${SCRIPT_DIR}/node_06_ligand_view.py"
