...
# -*- coding: utf-8 -*-
"""
Node 3: Ligand Selection - Select ligands
...
INPUT_DIR = os.path.join(SCRIPT_DIR, "output", "constructed_library")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "output", "selected_compounds")
...
def main():
    ...
    print("=== Node 3: Select ligands (random selection) ===")
    
    if not os.path.exists(INPUT_DIR):
        print(f"❌ Error: {INPUT_DIR} directory not found.")
        print("   Please run Node 2 (node_02_unpack_ligands.py) first.")
        exit(1)
