...
INPUT_PDB_DIR = os.path.join(SCRIPT_DIR, "..", "protein", "output")
INPUT_LIGAND_DIR = os.path.join(SCRIPT_DIR, "..", "ligand", "output")
...
def main():
    ...
    # Priority: 1) Environment variables (LIGAND_NAME, CHAIN_ID), 2) DEFAULT values, 3) First ligand found
